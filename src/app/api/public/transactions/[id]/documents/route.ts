...
// POST /api/public/transactions/[id]/documents - Upload transaction document (public for agent portal)
export async function POST(
  ...
  try {
    ...
    console.error('POST /api/public/transactions/[id]/documents error:', error);
    return NextResponse.json(
...
// GET /api/public/transactions/[id]/documents - Get all documents for a transaction
export async function GET(
  ...
  try {
    ...
    console.error('GET /api/public/transactions/[id]/documents error:', error);
    return NextResponse.json(
      { error: 'Internal server error' },
      { status: 500 }
    );
